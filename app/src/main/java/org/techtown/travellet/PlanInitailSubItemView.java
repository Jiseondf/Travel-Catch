...
public class PlanInitailSubItemView extends LinearLayout {
    TextView placeTime, placeName, placeMemo, transBudgetText, transportText;
    ImageView transportIc, transportBudget;

    public PlanInitailSubItemView(Context context) {
        super(context);
        init(context);
    }

    public PlanInitailSubItemView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
